# Form implementation generated from reading ui file '/home/bugo/github/Blocks_Screen/BlocksScreen/ui/customNumpad.ui'
#
...
class Ui_customNumpad(object):
    def setupUi(self, customNumpad):
        ...
        self.heater = QtWidgets.QLabel(parent=self.Input_frame)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.heater.setFont(font)
        self.heater.setStyleSheet("background: transparent; color: white;")
        self.heater.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.heater.setObjectName("heater")
        self.horizontalLayout.addWidget(self.heater)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, customNumpad):
        ...
        self.heater.setText(_translate("customNumpad", "Extruder"))
