...
class Ui_utilitiesStackedWidget:
    def setupUi(self, utilitiesStackedWidget):
        ...
        self.axis_maintenance_gb = QtWidgets.QButtonGroup(utilitiesStackedWidget)
        ...
        self.am_execute.setMouseTracking(False)
        self.am_execute.setTabletTracking(True)
        self.am_execute.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.NoContextMenu)
        self.am_execute.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.am_z.setChecked(False)
        self.am_z.setAutoExclusive(True)
        self.am_z.setFlat(True)
        self.am_z.setObjectName("am_z")
        ...
        self.am_x.setChecked(False)
        self.am_x.setAutoExclusive(True)
        self.am_x.setFlat(True)
