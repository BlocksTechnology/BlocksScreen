# Form implementation generated from reading ui file '/home/bugo/github/Blocks_Screen/BlocksScreen/lib/ui/filamentStackedWidget.ui'
#
...
class Ui_filamentStackedWidget(object):
    def setupUi(self, filamentStackedWidget):
        ...
        self.horizontalLayoutWidget = QtWidgets.QWidget(parent=self.filament_control_page)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(9, 9, 691, 71))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.filament_page_header_layout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        ...
        self.filament_page_header_title = QtWidgets.QLabel(parent=self.horizontalLayoutWidget)
        font = QtGui.QFont()
        ...
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.filament_control_page)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 90, 691, 297))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.filament_page_content_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.filament_page_content_layout.setContentsMargins(0, 0, 0, 0)
        self.filament_page_content_layout.setObjectName("filament_page_content_layout")
        ...
        self.filament_page_information.setObjectName("filament_page_information")
        self.filament_page_info_title = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.filament_page_info_title.setStyleSheet("background: transparent; color: white;")
        self.filament_page_info_title.setObjectName("filament_page_info_title")
        self.filament_page_information.addWidget(self.filament_page_info_title, 0, QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.filament_page_info_content = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.filament_page_info_content.setStyleSheet("background: transparent; color: white;")
        self.filament_page_info_content.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.filament_page_info_content.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.NoTextInteraction)
        self.filament_page_info_content.setObjectName("filament_page_info_content")
        self.filament_page_information.addWidget(self.filament_page_info_content, 0, QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.filament_page_content_layout.addLayout(self.filament_page_information)
        self.filament_page_button_group = QtWidgets.QHBoxLayout()
        self.filament_page_button_group.setObjectName("filament_page_button_group")
        self.filament_page_load_btn = BlocksCustomButton(parent=self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.filament_page_load_btn.setMinimumSize(QtCore.QSize(120, 60))
        self.filament_page_load_btn.setMaximumSize(QtCore.QSize(220, 70))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        ...
        self.filament_page_load_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.filament_page_load_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.filament_page_load_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        ...
        self.filament_page_unload_btn = BlocksCustomButton(parent=self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.filament_page_unload_btn.setMinimumSize(QtCore.QSize(120, 60))
        self.filament_page_unload_btn.setMaximumSize(QtCore.QSize(220, 70))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        font.setPointSize(20)
        font.setItalic(False)
        ...
        self.filament_page_unload_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.filament_page_unload_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.filament_page_unload_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        self.filament_page_unload_btn.setObjectName("filament_page_unload_btn")
        self.filament_page_button_group.addWidget(self.filament_page_unload_btn)
        self.filament_page_content_layout.addLayout(self.filament_page_button_group)
        ...
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(parent=self.load_page)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 691, 71))
        self.horizontalLayoutWidget_3.setObjectName("horizontalLayoutWidget_3")
        self.load_page_header_layout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_3)
        ...
        self.load_header_page_title = QtWidgets.QLabel(parent=self.horizontalLayoutWidget_3)
        ...
        self.load_header_back_button = BlocksCustomButton(parent=self.horizontalLayoutWidget_3)
        ...
        self.load_header_back_button.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.load_header_back_button.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.load_header_back_button.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        self.load_header_back_button.setProperty("icon_pixmap", QtGui.QPixmap(":/button_icons/media/graphics/back.svg"))
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 90, 691, 221))
        self.gridLayoutWidget_3.setObjectName("gridLayoutWidget_3")
        self.load_page_content_layout = QtWidgets.QGridLayout(self.gridLayoutWidget_3)
        ...
        self.load_nylon_btn = BlocksCustomButton(parent=self.gridLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.load_nylon_btn.setMinimumSize(QtCore.QSize(200, 60))
        self.load_nylon_btn.setMaximumSize(QtCore.QSize(250, 60))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        font.setPointSize(20)
        font.setItalic(False)
        ...
        self.load_nylon_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.load_nylon_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.load_nylon_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        ...
        self.load_petg_btn.setMinimumSize(QtCore.QSize(200, 60))
        self.load_petg_btn.setMaximumSize(QtCore.QSize(250, 60))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        font.setPointSize(20)
        font.setItalic(False)
        ...
        self.load_petg_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.load_petg_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.load_petg_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        ...
        self.load_abs_btn.setMinimumSize(QtCore.QSize(200, 60))
        self.load_abs_btn.setMaximumSize(QtCore.QSize(250, 60))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        font.setPointSize(20)
        font.setItalic(False)
        ...
        self.load_abs_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.load_abs_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.load_abs_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        ...
        self.load_tpu_btn.setMinimumSize(QtCore.QSize(200, 60))
        self.load_tpu_btn.setMaximumSize(QtCore.QSize(250, 60))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        font.setPointSize(20)
        font.setItalic(False)
        ...
        self.load_tpu_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.load_tpu_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.load_tpu_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        ...
        self.load_hips_btn.setMinimumSize(QtCore.QSize(200, 60))
        self.load_hips_btn.setMaximumSize(QtCore.QSize(250, 60))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        font.setPointSize(20)
        font.setItalic(False)
        ...
        self.load_hips_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.load_hips_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.load_hips_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        ...
        self.load_pla_btn.setMinimumSize(QtCore.QSize(200, 60))
        self.load_pla_btn.setMaximumSize(QtCore.QSize(250, 60))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        font.setPointSize(20)
        font.setItalic(False)
        ...
        self.load_pla_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.load_pla_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.load_pla_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        self.load_pla_btn.setObjectName("load_pla_btn")
        self.load_page_content_layout.addWidget(self.load_pla_btn, 0, 0, 1, 1)
        self.horizontalLayoutWidget_6 = QtWidgets.QWidget(parent=self.load_page)
        self.horizontalLayoutWidget_6.setGeometry(QtCore.QRect(10, 320, 691, 71))
        self.horizontalLayoutWidget_6.setObjectName("horizontalLayoutWidget_6")
        self.load_page_footer_layout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_6)
        ...
        self.load_custom_btn = BlocksCustomButton(parent=self.horizontalLayoutWidget_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.load_custom_btn.setMinimumSize(QtCore.QSize(200, 60))
        ...
        self.load_custom_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.load_custom_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.load_custom_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
        self.load_custom_btn.setObjectName("load_custom_btn")
        self.load_page_footer_layout.addWidget(self.load_custom_btn, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.custom_filament_header_back_btn = BlocksCustomButton(parent=self.horizontalLayoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.custom_filament_header_back_btn.setProperty("icon_pixmap", QtGui.QPixmap(":/button_icons/media/graphics/back.svg"))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 120, 691, 222))
        ...
        self.cfil_load_btn.setMinimumSize(QtCore.QSize(200, 60))
        self.cfil_load_btn.setMaximumSize(QtCore.QSize(200, 60))
        font = QtGui.QFont()
        font.setFamily("Momcake")
        font.setPointSize(20)
        font.setItalic(False)
        ...
        self.cfil_load_btn.setProperty("borderLeftPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part1.svg"))
        self.cfil_load_btn.setProperty("borderCenterPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part2.svg"))
        self.cfil_load_btn.setProperty("borderRightPixmap", QtGui.QPixmap(":/button_borders/media/buttons/btn_part3.svg"))
    ...
    def retranslateUi(self, filamentStackedWidget):
        ...
        self.filament_page_info_title.setText(_translate("filamentStackedWidget", "Loaded Filament Type:"))
        self.filament_page_info_content.setText(_translate("filamentStackedWidget", "My filament name"))
        ...
        self.custom_filament_header_back_btn.setProperty("button_type", _translate("filamentStackedWidget", "icon"))
