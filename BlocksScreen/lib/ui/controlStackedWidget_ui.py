...
class Ui_controlStackedWidget(object):
    def setupUi(self, controlStackedWidget):
        ...
        self.extrude_select_feedrate_4_btn = BlocksCustomCheckButton(parent=self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.extrude_select_feedrate_4_btn.sizePolicy().hasHeightForWidth())
        self.extrude_select_feedrate_4_btn.setSizePolicy(sizePolicy)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.BrushStyle.SolidPattern)
        palette.setBrush(QtGui.QPalette.ColorGroup.Active, QtGui.QPalette.ColorRole.Button, brush)
        ...
        brush.setStyle(QtCore.Qt.BrushStyle.SolidPattern)
        palette.setBrush(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.HighlightedText, brush)
        self.extrude_select_feedrate_4_btn.setPalette(palette)
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(False)
        self.extrude_select_feedrate_4_btn.setFont(font)
        self.extrude_select_feedrate_4_btn.setCheckable(True)
        self.extrude_select_feedrate_4_btn.setAutoRepeat(False)
        self.extrude_select_feedrate_4_btn.setAutoExclusive(False)
        self.extrude_select_feedrate_4_btn.setFlat(True)
        self.extrude_select_feedrate_4_btn.setObjectName("extrude_select_feedrate_4_btn")
        self.extrude_select_feedrate_group.addButton(self.extrude_select_feedrate_4_btn)
        self.exp_feedrate_content_layout.addWidget(self.extrude_select_feedrate_4_btn)
        self.extrude_select_feedrate_8_btn = BlocksCustomCheckButton(parent=self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.extrude_select_feedrate_8_btn.sizePolicy().hasHeightForWidth())
        self.extrude_select_feedrate_8_btn.setSizePolicy(sizePolicy)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.BrushStyle.SolidPattern)
        palette.setBrush(QtGui.QPalette.ColorGroup.Active, QtGui.QPalette.ColorRole.Button, brush)
        ...
        brush.setStyle(QtCore.Qt.BrushStyle.SolidPattern)
        palette.setBrush(QtGui.QPalette.ColorGroup.Disabled, QtGui.QPalette.ColorRole.HighlightedText, brush)
        self.extrude_select_feedrate_8_btn.setPalette(palette)
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(False)
        self.extrude_select_feedrate_8_btn.setFont(font)
        self.extrude_select_feedrate_8_btn.setCheckable(True)
        self.extrude_select_feedrate_8_btn.setAutoRepeat(False)
        self.extrude_select_feedrate_8_btn.setAutoExclusive(False)
        self.extrude_select_feedrate_8_btn.setFlat(True)
        self.extrude_select_feedrate_8_btn.setObjectName("extrude_select_feedrate_8_btn")
        self.extrude_select_feedrate_group.addButton(self.extrude_select_feedrate_8_btn)
        self.exp_feedrate_content_layout.addWidget(self.extrude_select_feedrate_8_btn)
...
"Home"))
        ...
        self.extrude_select_feedrate_4_btn.setText(_translate("controlStackedWidget", "4"))
        self.extrude_select_feedrate_4_btn.setProperty("button_type", _translate("controlStackedWidget", "normal"))
        self.extrude_select_feedrate_8_btn.setText(_translate("controlStackedWidget", "8"))
        self.extrude_select_feedrate_8_btn.setProperty("button_type", _translate("controlStackedWidget", "normal"))
