...
"}")
        ...
        self.main_widget.setStyleSheet("#main_widget{background-image: url(:/background/1st_background.png);}")
...
"}")
        ...
        self.extruder_temp_display = BlocksCustomButton(parent=self.header_display_layout)
        ...
        self.extruder_temp_display.setProperty("icon_pixmap", QtGui.QPixmap(":/button_icons/media/btn_icons/temperature_icon.svg"))
        ...
        self.filament_type_display = BlocksCustomButton(parent=self.header_display_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.filament_type_display.sizePolicy().hasHeightForWidth())
        self.filament_type_display.setSizePolicy(sizePolicy)
        self.filament_type_display.setMinimumSize(QtCore.QSize(60, 30))
        self.filament_type_display.setMaximumSize(QtCore.QSize(120, 60))
        self.filament_type_display.setText("")
        self.filament_type_display.setFlat(True)
        self.filament_type_display.setProperty("icon_pixmap", QtGui.QPixmap(":/icons/media/main_menu/ICON_filament_pressed.png"))
        self.filament_type_display.setObjectName("filament_type_display")
        self.header_grid_layout.addWidget(self.filament_type_display, 0, 2, 1, 1)
        self.nozzle_size_display = BlocksCustomButton(parent=self.header_display_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.nozzle_size_display.sizePolicy().hasHeightForWidth())
        self.nozzle_size_display.setSizePolicy(sizePolicy)
        self.nozzle_size_display.setMinimumSize(QtCore.QSize(60, 30))
        self.nozzle_size_display.setMaximumSize(QtCore.QSize(120, 60))
        self.nozzle_size_display.setText("")
        self.nozzle_size_display.setIconSize(QtCore.QSize(60, 60))
        self.nozzle_size_display.setFlat(True)
        self.nozzle_size_display.setProperty("icon_pixmap", QtGui.QPixmap(":/top_bar_icons/media/topbar/nozzle_temp_topbar.svg"))
        self.nozzle_size_display.setObjectName("nozzle_size_display")
        self.header_grid_layout.addWidget(self.nozzle_size_display, 0, 3, 1, 1)
        self.bed_temp_display = BlocksCustomButton(parent=self.header_display_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.wifi_button.setProperty("icon_pixmap", QtGui.QPixmap(":/top_bar_icons/media/topbar/signal_very_good_signal.svg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filament_type_display.setProperty("name", _translate("MainWindow", "filament_type_display"))
        self.filament_type_display.setProperty("button_type", _translate("MainWindow", "display"))
        self.nozzle_size_display.setProperty("button_type", _translate("MainWindow", "display"))
