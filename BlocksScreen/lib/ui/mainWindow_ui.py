...
"}")
        ...
        self.main_widget.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
...
"")
        ...
        self.main_content_widget = NotificationQTabWidget(self.main_widget)
        ...
        self.main_content_widget.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
        self.main_content_widget.setLayoutDirection(QtCore.Qt.RightToLeft)
...
"\n"
"")
        self.main_content_widget.setTabPosition(QtWidgets.QTabWidget.West)
        self.main_content_widget.setTabShape(QtWidgets.QTabWidget.Rounded)
        self.main_content_widget.setIconSize(QtCore.QSize(60, 60))
        self.main_content_widget.setElideMode(QtCore.Qt.ElideLeft)
        ...
        self.printTab.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
        self.printTab.setObjectName("printTab")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_home.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_home_pressed.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_home_blocked.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        ...
        self.filamentTab.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
        self.filamentTab.setObjectName("filamentTab")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_filament.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_filament_pressed.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon1.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_filamente_blocked.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        ...
        self.controlTab.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
        self.controlTab.setObjectName("controlTab")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_control.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_control_pressed.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon2.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_control_blocked.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        ...
        self.utilitiesTab.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
        self.utilitiesTab.setObjectName("utilitiesTab")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_utilities.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_utilities_pressed.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap(":/icons/media/main_menu/ICON_utilities_blocked.png"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        self.main_content_widget.addTab(self.utilitiesTab, icon3, "")
        self.main_header_layout = QtWidgets.QGroupBox(self.main_widget)
        ...
        self.main_header_layout.setCursor(QtGui.QCursor(QtCore.Qt.BlankCursor))
        self.main_header_layout.setLayoutDirection(QtCore.Qt.LeftToRight)
...
"}")
        ...
        self.main_header_layout.setAlignment(QtCore.Qt.AlignJustify|QtCore.Qt.AlignVCenter)
        ...
        self.header_main_layout.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        ...
        self.notification_btn = IconButton(self.main_header_layout)
        ...
        self.header_main_layout.addWidget(self.notification_btn, 0, QtCore.Qt.AlignLeft)
        self.extruder_temp_display = DisplayButton(self.main_header_layout)
        ...
        self.header_main_layout.addWidget(self.extruder_temp_display, 0, QtCore.Qt.AlignHCenter)
        self.bed_temp_display = DisplayButton(self.main_header_layout)
        ...
        self.header_main_layout.addWidget(self.bed_temp_display, 0, QtCore.Qt.AlignHCenter)
        self.chamber_temp_display = DisplayButton(self.main_header_layout)
        ...
        self.header_main_layout.addWidget(self.chamber_temp_display, 0, QtCore.Qt.AlignHCenter)
        self.filament_type_icon = IconButton(self.main_header_layout)
        ...
        self.header_main_layout.addWidget(self.filament_type_icon, 0, QtCore.Qt.AlignHCenter)
        self.nozzle_size_icon = IconButton(self.main_header_layout)
        ...
        self.header_main_layout.addWidget(self.nozzle_size_icon, 0, QtCore.Qt.AlignHCenter)
        self.wifi_button = IconButton(self.main_header_layout)
        ...
        self.header_main_layout.addWidget(self.wifi_button, 0, QtCore.Qt.AlignRight|QtCore.Qt.AlignTop)
...
import background_resources_rc
import font_rc
import graphic_resources_rc
import icon_resources_rc
import main_menu_resources_rc
import system_resources_rc
import top_bar_resources_rc
