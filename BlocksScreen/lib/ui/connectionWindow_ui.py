...
class Ui_ConnectivityForm(object):
    def setupUi(self, ConnectivityForm):
        ...
        ConnectivityForm.setStyleSheet("#ConnectivityForm{background-image: url(:/background/media/1st_background.png);}")
        ...
        self.updatepageButton.setMinimumSize(QtCore.QSize(154, 80))
        self.updatepageButton.setMaximumSize(QtCore.QSize(154, 80))
