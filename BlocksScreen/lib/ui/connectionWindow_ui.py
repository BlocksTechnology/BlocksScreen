...
"")
        ...
        self.RebootSystemButton = BlocksCustomButton(parent=self.cw_buttonFrame)
        ...
        self.RebootSystemButton.setMinimumSize(QtCore.QSize(60, 60))
        self.RebootSystemButton.setMaximumSize(QtCore.QSize(60, 60))
        ...
        self.RebootSystemButton.setProperty("icon_pixmap", QtGui.QPixmap(":/system/media/btn_icons/system_reboot.svg"))
        ...
        self.RestartKlipperButton.setProperty("iconPixmap", QtGui.QPixmap(":/system_icons/media/btn_icons/restart_klipper.svg"))
        ...
        self.RetryConnectionButton = BlocksCustomButton(parent=self.cw_buttonFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.RetryConnectionButton.setMinimumSize(QtCore.QSize(60, 60))
        self.RetryConnectionButton.setMaximumSize(QtCore.QSize(60, 60))
        self.RetryConnectionButton.setBaseSize(QtCore.QSize(60, 80))
        palette = QtGui.QPalette()
        ...
        self.RetryConnectionButton.setProperty("icon_pixmap", QtGui.QPixmap(":/system_icons/media/btn_icons/retry_connection.svg"))
        ...
        self.wifi_button = BlocksCustomButton(parent=self.cw_buttonFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.wifi_button.setBaseSize(QtCore.QSize(60, 60))
        ...
        self.wifi_button.setProperty("icon_pixmap", QtGui.QPixmap(":/wifi_icons/media/btn_icons/wifi_settings.svg"))
...
"")
    ...
    def retranslateUi(self, ConnectivityForm):
        ...
        self.RebootSystemButton.setProperty("button_type", _translate("ConnectivityForm", "icon"))
        ...
        self.RetryConnectionButton.setProperty("button_type", _translate("ConnectivityForm", "icon_text"))
        ...
        self.wifi_button.setProperty("button_type", _translate("ConnectivityForm", "icon"))
