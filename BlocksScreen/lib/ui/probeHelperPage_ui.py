...
class Ui_probe_offset_page(object):
    def setupUi(self, probe_offset_page):
        ...
        self.start_button.setProperty("icon_pixmap", QtGui.QPixmap(":/misc/media/btn_icons/start_hugo.svg"))
        ...
        self.tool_info_text.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.NoTextInteraction)
    ...
    def retranslateUi(self, probe_offset_page):
        ...
        self.start_button.setProperty("button_type", _translate("probe_offset_page", "icon_text"))
        self.start_button.setProperty("text_formatting", _translate("probe_offset_page", "bottom"))
