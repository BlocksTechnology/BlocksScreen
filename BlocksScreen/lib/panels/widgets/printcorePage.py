...
class SwapPrintcorePage(QtWidgets.QDialog):
    ...
    def resizeEvent(self, event: QtGui.QResizeEvent) -> None:
        ...
        # Calculate label geometry first
        label_margin = 20
        label_height = int(self.height() * 0.65) - label_margin
        self.label.setGeometry(label_margin, 60, self.width() - 2 * label_margin, label_height)
        # Calculate button geometry based on the window's dimensions
        button_width = 250
        button_height = 80
        spacing = 100
        ...
        self.pc_cancel.setGeometry(start_x + button_width+100 , button_y, button_width, button_height)
    ...
    def setupUI(self) -> None:
        ...
        self.pc_cancel.setProperty("icon_pixmap", QtGui.QPixmap(":/dialog/media/btn_icons/no.svg"))
        ...
        self.pc_accept.setProperty("icon_pixmap", QtGui.QPixmap(":/dialog/media/btn_icons/yes.svg"))
