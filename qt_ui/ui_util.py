...
class CustomNumpad(QWidget):
    ...
    def reset_numpad(self) -> bool:
        ...
        try:
            ...
            _logger.debug(f"Could not reset numpad, error message caught : {e}")
...
class RoutingQueue(queue.LifoQueue):
    ...
    def clear_queues(self):
        ...
        try:
            with self.mutex:  # This mutex is already associated with queeus no need to declare it
            ...
            self._logger.exception("Unexpected error while clearing queues.")
            return False
