...
"}")
        ...
        self.back_btn.setGeometry(QtCore.QRect(520, 0, 71, 51))
        ...
        self.listWidget.setGeometry(QtCore.QRect(0, 0, 481, 241))
    ...
    def retranslateUi(self, printStackedWidget):
        ...
        item.setText(_translate("printStackedWidget", "tem one"))
