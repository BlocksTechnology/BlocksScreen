...
class TestAMUManagerInit:
    ...
    def test_initial_amu_inactive(self, manager) -> None:
        assert manager.is_amu_active() is False

    def test_no_config_file_sets_filename_none(self, manager) -> None:
...
class TestToggleAMUSystem:
    ...
    def test_activate_sets_amu_active(self, manager_with_cfg, qtbot) -> None:
        mgr, _ = manager_with_cfg
